...
export function Header({ isDarkMode, setIsDarkMode, onMenuClick, userId }: HeaderProps) {
  ...
  // Ambil data profile sesuai userId (sama seperti ProfilePage kamu)
  useEffect(() => {
      ...
      <div className="flex items-center justify-between px-4 lg:px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          <div className={`flex items-center gap-2 px-4 py-2 rounded-full ${
            isConnected ? 'bg-[#2ECC71]/10' : 'bg-[#E53935]/10'
          }`}>
            {isConnected ? (
              <>
